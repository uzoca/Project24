...
if (echartElemPie) {
    ...
    echartPie.setOption({
        color: ['#0000ff', '#0044ff', '#0066ff', '#3388ff', '#55aaff ', '#77ccff'],
        tooltip: {
            show: true,
            backgroundColor: 'rgba(0, 0, 0, .8)'
        },
        ...
        series: [{
            ...
            center: ['50%', '50%'],
            data: [
                { value: 535, name: 'Students support' }, 
                { value: 310, name: 'Admin staff wellfare' }, 
                { value: 234, name: 'Security' }, 
                { value: 155, name: 'Hostel clean up' }, 
                { value: 130, name: 'Recreation' }
            ],
            itemStyle: {
                emphasis: {
                    shadowBlur: 10,
...
var echartElemFirst = document.getElementById('echartfirst');

if (echartElemFirst) {
   
    var echart4 = echarts.init(echartElemFirst);
    
    echart4.setOption(_extends({}, echartOptions.lineNoAxis, {
        series: [{
            grid:"show",
            data: [40, 80, 20, 90, 30, 80, 40, 90, 20, 80, 30, 45, 50, 110, 90, 140],
            lineStyle: _extends({
